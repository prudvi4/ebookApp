...
<title>Forgot Password : E-Book Application</title>

<%@ include file="all_component/allcss.jsp"%>
</head>
<body>

	<!-- Navbar for only for Forgot Password So creating different Navbar for this -->
				...
				<div class="card">
					<div class="card-body">
						...
						<c:if test="${not empty userobj}">
							<p class="text-center text-success">UserPassword:${userobj.password }</p>
							<c:remove var="userobj" scope="session" />
						</c:if>
						<form action="ForPasswordServlet" method="post">
